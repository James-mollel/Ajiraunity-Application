...
import { 
  Menu, X, LayoutDashboard, Building2,FilePlus,
   LogOut, ArrowLeftFromLine , BriefcaseBusiness,
    Users2, Settings, Headset,User2 , MessageCircle,Mail, 
    Phone
            ...
            >
                ...
                <div className="flex flex-col h-full">
                    ...
                    <nav className="flex-grow p-4 space-y-2 overflow-y-auto">
                        ...
                        {[
                            { icon: LayoutDashboard, label: 'Dashboard', link: '/dashboard-user-employer/', isActive: true, color: 'text-white bg-black/65' },
                            { icon: FilePlus, label: 'Post Jobs', link: '/dashboard-user-employer/choose-kind-post-jobs/',color: 'text-green-700 bg-green-500/15' },
                            { icon: BriefcaseBusiness, label: 'My Jobs', link: '/dashboard-user-employer/all-employers-jobs-posted/', color: 'text-fuchsia-800 bg-fuchsia-500/15' },
                            { icon: Users2, label: 'Job Applicants', link: '/dashboard-user-employer/all-appplications-employer/', color: 'text-lime-700 bg-lime-500/15' },
                            { icon: Building2, label: 'My Companies', link: '/dashboard-user-employer/list-all-companies-employer/', color: 'text-indigo-800 bg-indigo-500/15' },
                            { icon: Headset, label: 'Need Help', link: '/dashboard-user-job-seeker/123', color: 'text-fuchsia-800 bg-fuchsia-500/15' },
                            { icon: Settings, label: 'Profile & settings', link: '/dashboard-user-employer/employer-profiles-settings', color: ' text-amber-700 bg-amber-500/25' },
                        ].map((item, index) => (
                            ...
                            <NavLink key={index} to={item.link} className='block group transition-colors duration-200'
                                ...
                                end={item.link ==='/dashboard-user-employer/'}
                                >
                                {({isActive})=>(
                                     <div 
                                    className={`
