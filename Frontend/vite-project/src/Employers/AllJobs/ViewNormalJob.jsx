...
import { 
    ...
    DollarSign, BookOpen, Users, Hash, MessageCircleMore, Mail, AppWindow
} from "lucide-react";

export default function ViewNormalJobDetails() {
    ...
    const {
        title, post_type, code, category, education_leveldisplay, 
         gender_display, positions_needed, deadline, job_summary, 
          currency, salary_max, salary_min,  
        payment_period_display, region, district, ward, apply_email, 
            ...
            <header className="bg-white rounded-xl shadow-xl p-6 border border-gray-100">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex gap-3 w-full sm:w-auto flex-shrink-0">
                        <button onClick={()=> navigate(`/dashboard-user-employer/edit-normal-job-page/${JobPk}`)} className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium border border-indigo-300 text-indigo-700 bg-indigo-50 rounded-xl hover:bg-indigo-100 transition shadow-md w-1/2 sm:w-auto">
